...
stats_path = "/home/pkarageorgis/geo_octo/libero_datasets/unified_stats/unified_dataset_statistics_libero_object_vggt.json"
...
def eval_libero(cfg: GenerateConfig) -> float:
    ...
    # NEW! >> Print model and checkpoint info to the log file and console.
    log_message("\n" + "="*50, log_file)
